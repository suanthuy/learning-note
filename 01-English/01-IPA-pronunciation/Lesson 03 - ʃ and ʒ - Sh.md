# Lesson 03 - /ʃ/ ("sh") and /ʒ/ ("zh")

## /ʃ/ ("sh")

The /ʃ/ sound (called "esh" or "voiceless postalveolar fricative") is the "sh" in ship, she, fish, push, machine, and sugar. It's a soft, hissing "shhh" made toward the roof of your mouth.

- **Tongue position**: Raise the middle/front of your tongue toward the roof of your mouth (hard palate), but don't touch—leave a small groove for air.
- **Airflow**: Push air through the narrow groove, creating a smooth, diffused "shhh" hiss (wider than /s/).
- **No voice**: Pure breathy friction—no vibration.
- **Lip position**: Slightly rounded/pursed (like whispering "oo"), which shapes the sound.
- **Jaw**: Slightly dropped and relaxed.

## /ʒ/ ("zh")

- Start like /ʃ/, but add voice – vibrate your vocal cords (feel your throat buzz).
- Same tongue and lip position as /ʃ/, but softer and buzzier.
- Air flows smoothly with vibration (voiced sound).
